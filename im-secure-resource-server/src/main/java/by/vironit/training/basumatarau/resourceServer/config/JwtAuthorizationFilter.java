...
public class JwtAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        final String responseTokenHeader = response.getHeader(SecurityConstants.TOKEN_HEADER);
        final String requestTokenHeader = request.getHeader(SecurityConstants.TOKEN_HEADER);

        UsernamePasswordAuthenticationToken authentication = getAuthentication(responseTokenHeader);
        if(authentication == null){
            authentication = getAuthentication(requestTokenHeader);
            if(authentication == null){
