...
import by.vironit.training.basumatarau.messenger.dto.DistributedMessageDto;
            ...
            public void afterConnected(final StompSession session, StompHeaders connectedHeaders) {
                session.subscribe("/topic/greetings", new StompFrameHandler() {
                    ...
                    public Type getPayloadType(StompHeaders headers) {
                        return PrivateMessageDto.class;
                    }

                    @Override
                    public void handleFrame(StompHeaders headers, Object payload) {
                        PrivateMessageDto greeting = (PrivateMessageDto) payload;
                        try {
                ...
                try {
                        session.send("/app/hello", new PrivateMessageDto("Hello world!"));
                } catch (Throwable t) {
                    failure.set(t);
                    latch.countDown();
                }
